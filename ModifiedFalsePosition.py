...
class ModifiedFalsePosition:
    def __init__(self,Data):
        self.Data = Data
        print("You have chosen the Modified False Position method of finding roots")
        self.xu = []
        self.fxu = []
        self.xl = []
        self.fxl = []
    ...
    def compute(self,a,b,estError, maxIter):
        c = b - (self.Data.f(b)*((b-a)/(self.Data.f(b)-self.Data.f(a))))
        i = 0
        self.xu.append(b)
        self.xl.append(a)
        self.xr.append(c)
        ...
        while i < maxIter:
            ...
            if self.Data.f(c) == 0:
                ...
                a=c
            try:
                if self.xu[-1] == self.xu[-2] and self.xu[-2] == self.xu[-3]:
                    c = b - (0.5*self.Data.f(b)*((b-a)/(self.Data.f(b)-self.Data.f(a))))
                else:
                    c = b - (self.Data.f(b)*((b-a)/(self.Data.f(b)-self.Data.f(a))))
            except:
                c = b - (self.Data.f(b)*((b-a)/(self.Data.f(b)-self.Data.f(a))))
